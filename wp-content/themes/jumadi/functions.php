...
define( 'JUMADI_VERSION', '1.0.2' );

if ( ! function_exists( 'jumadi_setup' ) ) {
	add_action( 'after_setup_theme', 'jumadi_setup' );
	/**
	 * Sets up theme defaults and registers support for various WordPress features.
	 *
	 */
	function jumadi_setup() {
		// Make theme available for translation.
		load_theme_textdomain( 'jumadi' );
		...
		register_nav_menus( array(
			'primary' => __( 'Primary Menu', 'jumadi' ),
		) );

		/**
		 * Set the content width to something large
		 * We set a more accurate width in jumadi_smart_content_width()
		 */
...
define('JUMADI_THEME_URL','https://wpkoi.com/jumadi-wpkoi-wordpress-theme/');
define('JUMADI_WPKOI_AUTHOR_URL','https://wpkoi.com/');
define('JUMADI_WPKOI_SOCIAL_URL','https://www.facebook.com/wpkoithemes/');
define('JUMADI_WORDPRESS_REVIEW','https://wordpress.org/support/theme/jumadi/reviews/?filter=5');
define('JUMADI_DOCUMENTATION','https://wpkoi.com/docs/');
define('JUMADI_FONT_AWESOME_LINK','https://fontawesome.com/icons');
